...
type Database interface {
	...
	GetUsageLogsByDateRange(ctx context.Context, accountID uuid.UUID, start, end time.Time) ([]*UsageLog, error)
	...
	GetPendingSettlements(ctx context.Context, maxAttempts int, limit int) ([]*PaymentTransaction, error)
